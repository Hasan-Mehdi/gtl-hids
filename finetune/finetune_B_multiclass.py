...
def main():
    ...
    # Define file paths
    train_output = "finetune_dataset_B.csv"
    ...
    training_args = TrainingArguments(
        output_dir="cicids_finetuned_multiclass_B",
        num_train_epochs=3,
    ...
    model.save_pretrained("cicids_finetuned_multiclass_B")
    tokenizer.save_pretrained("cicids_finetuned_multiclass_B")
