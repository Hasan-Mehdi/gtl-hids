...
TCP Flags: Not specified
Duration: 4475174 ms
This is MALICIOUS traffic showing unsuccessful FTP brute force attempts.
...
TCP Flags: Not specified
Duration: 3187 ms
This is MALICIOUS traffic showing unsuccessful SSH brute force attempts.
...
TCP Flags: Not specified
Duration: 5964859 ms
This is MALICIOUS traffic showing unsuccessful slowloris attack attempts.
...
This is MALICIOUS traffic showing unsuccessful slow HTTP attack attempts.
...
TCP Flags: Not specified
Duration: 7078331 ms
This is MALICIOUS traffic showing unsuccessful HTTP Unbearable Load King DoS attack attempts.
...
This is MALICIOUS traffic targeting HTTP servers.
...
TCP Flags: Not specified
Duration: 2951 ms
This is MALICIOUS traffic showing unsuccessful GoldenEye DoS attack attempts.
...
This is MALICIOUS traffic showing web application login brute force attack patterns.
...
TCP Flags: Not specified
Duration: 1641488 ms
This is MALICIOUS traffic showing unsuccessful web application brute force login attempts.
...
This is MALICIOUS traffic showing Cross-Site Scripting attack against web applications.
...
TCP Flags: Not specified
Duration: 5466100 ms
This is MALICIOUS traffic showing unsuccessful Cross-Site Scripting attack attempts.
...
TCP Flags: Not specified
Duration: 5039303 ms
This is MALICIOUS traffic showing SQL Injection attack against web application databases.
...
TCP Flags: Not specified
Duration: 33898 ms
This is MALICIOUS traffic showing unsuccessful SQL Injection attack attempts.
...
This is MALICIOUS traffic showing malware infiltration activity.
...
TCP Flags: Not specified
Duration: 588 ms
This is MALICIOUS traffic showing unsuccessful infiltration attempts.
...
TCP Flags: Not specified
Duration: 755441 ms
This is MALICIOUS traffic showing scanning activity as part of an infiltration.
...
TCP Flags: Not specified
Duration: 81379 ms
This is MALICIOUS traffic showing botnet command and control communication.
...
TCP Flags: Not specified
Duration: 1305 ms
This is MALICIOUS traffic showing unsuccessful botnet communication attempts.
...
TCP Flags: Not specified
Duration: 44 ms
This is MALICIOUS traffic showing scanning activity to discover open ports and services.
...
TCP Flags: Not specified
Duration: 9157589 ms
This is MALICIOUS traffic showing distributed denial of service attack patterns.
...
class ZeroShotTester:
    ...
    def evaluate_files(self, data_dir, output_dir, target_file="dataset_A_10k.csv", samples_per_file=10000):
...
def main():
    ...
    parser.add_argument("--samples_per_file", type=int, default=10000, 
