...
class MulticlassClassifier:
    ...
    def evaluate_files(self, data_dir, output_dir, target_file="test_thurs_friday_10000.csv", samples_per_file=100):
...
def main():
    ...
    parser.add_argument("--target_file", default="test_thurs_friday_10000.csv", 
